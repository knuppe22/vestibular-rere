...
public class VORStage : Stage {
    ...
    */
    ...
    protected override void Init()
    {
        ...
        markerInstance.transform.localEulerAngles = new Vector3(0, 0, direction.y * 90);
        markers = new Image[2];
    ...
    */
    ...
    {
        Debug.Log(curCycle + " Head: " + headVector + ", " + bestHeadVector);
        Debug.Log(curCycle + " Eye: " + eyeVector + ", " + bestEyeVector);
